  ...
  return (
    <>
      <SEOHead
        ...
        canonical="https://smileartdental.pl/blog"
      />

      <section className="bg-navy pt-20 pb-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-heading text-3xl md:text-5xl text-primary-foreground mb-4">Blog stomatologiczny</h1>
          <p className="text-light text-lg font-body">Porady naszych lekarzy — wiedza, która dba o Twoje zęby</p>
        </div>
      </section>
      ...
      <main id="main" className="py-12 bg-background">
        <div className="container mx-auto px-4">
            ...
            {filtered.map((post, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h2 className="font-heading text-lg text-foreground mb-2 group-hover:text-gold transition-colors">{post.title}</h2>
          ...
          {filtered.length === 0 && (
            <p className="text-center text-muted-foreground font-body py-12">Brak artykułów w tej kategorii.</p>
          )}
        </div>
      </main>
    </>
