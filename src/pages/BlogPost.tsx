    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/blog" className="text-gold font-body hover:underline">
            ← Wróć do bloga
          </Link>
        </div>
      </div>
    ...
    <>
      ...
      <section className="bg-navy pt-20 pb-12">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <span className="inline-block bg-accent/20 border border-accent/30 text-gold text-xs font-body font-bold px-3 py-1 rounded-full mb-4">
            {post.category}
          </span>
          <h1 className="font-heading text-2xl md:text-4xl text-primary-foreground mb-4">
            {post.title}
          </h1>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="relative overflow-hidden rounded-lg mb-10 bg-navy p-8 md:p-10 shadow-card">
            ...
            <div className="relative flex min-h-64 flex-col justify-between gap-8 md:flex-row md:items-end">
              <div className="max-w-xl">
                ...
                <p className="mt-4 text-light font-body leading-relaxed">{post.excerpt}</p>
              </div>
              <div className="self-start md:self-auto">
                <div className="w-24 h-24 rounded-full border border-accent/30 bg-white/5 backdrop-blur-sm flex items-center justify-center">
                  <svg width="52" height="52" viewBox="0 0 40 40" fill="none" aria-hidden="true">
                    <path
                      d="M20 5c-6 0-8 4-8 8 0 6 4 12 6 16 .5 1 1 2 2 2s1.5-1 2-2c2-4 6-10 6-16 0-4-2-8-8-8z"
                      stroke="currentColor"
                      strokeWidth="2"
                      className="text-gold"
                    />
                    <path
                      d="M16 12a4 4 0 018 0"
                      stroke="currentColor"
                      strokeWidth="1.5"
          ...
          <div className="bg-accent-light rounded-lg p-8 my-10 text-center">
            ...
            <p className="text-muted-foreground font-body mb-4">
              Umów bezpłatną konsultację z naszym specjalistą.
            </p>
          ...
          <div className="flex items-center gap-4 p-6 bg-card rounded-lg shadow-card mb-10">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm font-body">{siteConfig.name}, Kraków</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {related.map((relatedPost) => (
              ...
              >
                ...
                <div className="p-4">
                  <span className="text-xs text-gold font-body font-bold">{relatedPost.category}</span>
                  <h4 className="font-heading text-base text-foreground group-hover:text-gold transition-colors mt-1">
                    {relatedPost.title}
                  </h4>
                </div>
              </Link>
